    ...
    <div className='shop-category mt-8'>
      <div className='shopcategory-indexSort'>
        ...
        <div className="shopcategory-sort">
          <p className='text-white bg-transparent'>Sort By</p>
      ...
      {productArr.length !== 0 && <div className="shopcategory-loadmore bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700">
        Explore More
      </div>}
    </div>
  )
